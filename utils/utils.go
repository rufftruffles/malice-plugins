...
// AskForConfirmation prompts user for yes/no response. In a non-interactive
// context (daemon/docker/CI, stdin at EOF) it returns false instead of
// log.Fatalling, so a missing prompt never takes the process down.
